<template>
  <div class="modal" v-if="render">
    <div class="modal-wrapper-close" @click="this.$store.dispatch('appGlobal/setShowClaimRewardModal',false);this.waitingForTransaction=false;"></div>
    <div class="modal-wrapper">
      <div class="modal-header">
        <div class="modal-name">{{translatesGet('CLAIM_REWARD')}}</div>
        <button class="btn-close" @click="this.$store.dispatch('appGlobal/setShowClaimRewardModal',false);this.waitingForTransaction=false;">
